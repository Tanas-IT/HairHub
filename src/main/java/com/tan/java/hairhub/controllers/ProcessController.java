...
public class ProcessController {
    ...
    @GetMapping("/getAll")
    public ResponseEntity<ApiResponse<List<ProcessResponse>>> getAllProcess(@RequestParam int pageIndex, @RequestParam int pageSize) {
    ...
    @PutMapping("/update")
    public ResponseEntity<ApiResponse<Process>> updateProcess(@RequestBody UpdateProcessDTO updateProcessDTO) throws Exception {
