...
public class ServiceController {
    ...
    @GetMapping("/getAll")
    public ResponseEntity<ApiResponse<List<ServiceResponse>>> getAllService(@RequestParam int pageIndex, @RequestParam int pageSize) {
    ...
    @PutMapping("/update")
    public ResponseEntity<ApiResponse<Service>> updateService(@RequestBody UpdateServiceDTO updateServiceDTO) throws Exception {
