...
public class ScheduleController {
    ...
    @GetMapping("/getAll")
    public ResponseEntity<ApiResponse<List<ScheduleResponse>>> getAllSchedule(@RequestParam int pageIndex, @RequestParam int pageSize) {
    ...
    @PostMapping("/create")
    public ResponseEntity<ApiResponse<ScheduleResponse>> createSchedule(@RequestBody CreateScheduleDTO createScheduleDTO) {
    ...
    @PutMapping("/update")
    public ResponseEntity<ApiResponse<com.tan.java.hairhub.entities.Schedule>> updateSchedule(@RequestBody UpdateScheduleDTO updateScheduleDTO) throws Exception {
